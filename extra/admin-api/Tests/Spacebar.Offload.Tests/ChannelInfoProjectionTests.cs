...
public class ChannelInfoProjectionTests {
    ...
    public void SelectPersistedChannelStatusesIncludesStatusWithoutVoiceStates() {
        var channels = new[] {
            new DbChannel { Id = 1, Type = 2, GuildId = 10, Status = "Planning" },
            new DbChannel { Id = 2, Type = 2, GuildId = 10, Status = null },
            new DbChannel { Id = 3, Type = 2, GuildId = 10, Status = "" },
            new DbChannel { Id = 4, Type = 0, GuildId = 10, Status = "Text" },
            new DbChannel { Id = 5, Type = 2, GuildId = 11, Status = "Other guild" },
        }.AsQueryable();
    ...
    public void SelectActiveVoiceChannelInfosRequiresVoiceStates() {
        var channels = new[] {
            new DbChannel { Id = 1, Type = 2, GuildId = 10, Status = "Planning" },
            new DbChannel { Id = 2, Type = 2, GuildId = 10, Status = "Active", VoiceStates = { new DbVoiceState { Id = 20 } } },
            new DbChannel { Id = 3, Type = 0, GuildId = 10, Status = "Text", VoiceStates = { new DbVoiceState { Id = 30 } } },
            new DbChannel { Id = 4, Type = 2, GuildId = 11, Status = "Other guild", VoiceStates = { new DbVoiceState { Id = 40 } } },
        }.AsQueryable();
