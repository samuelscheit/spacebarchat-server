# Feature: Toggle voice deafen

Run: 2026-05-07T23-06-28Z-stable-local
Scenario: voice.deafen_toggle
...
- probable: GET /channels/{channel_id}/voice-history
  ...
  - response sample redacted: {"global":false,"message":"You are being rate limited.","retry_after":457.357}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- probable: GET /users/@me/survey
  - status codes: 429
  - response shape: sha256:03c791a2bff466a1f917bc4db83ed31cddd76160e2ce2fe94070faff2bd6e015
  - response sample redacted: {"global":false,"message":"You are being rate limited.","retry_after":79779.97}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFHuTiL18z7BJ4BAAAWAAAA","client_viewport_height":720,"client_viewport_width":1280,"error_message":"You are being rate limited.","event_sequence_number":28,"launch_signature":"{uuid}","rendered_locale":"en-US","request_method":"get","status_code":429,"uptime_app":1,"url":"{redacted_string}"},"type":"network_action_user_survey_fetch"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"app_hardware_acceleration_enabled":true,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFHuTiL18z7BJ4BAAAXAAAA","client_viewport_height":720,"client_viewport_width":1280,"css_compressed_byte_size":472056,"css_transfer_byte_size":0,"css_uncompressed_byte_size":3215111,"duration_ms_since_app_opened":3026,"event_sequence_number":29,"js_compressed_byte_size":517607,"js_transfer_byte_size":0,"js_uncompressed_byte_size":2097710,"launch_signature":"{uuid}","load_id":"{uuid}","rendered_locale":"en-US","screen_name":"{redacted_string}","total_compress...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFHuTiL18z7BJ4BAAAaAAAA","client_viewport_height":720,"client_viewport_width":1280,"evaluation_id":"61f72003","event_sequence_number":32,"exposure_location":"voice call initiated","launch_signature":"{uuid}","rendered_locale":"en-US","unit_type":"user","uptime_app":2},"type":"experiment_user_evaluation_exposed"},{"properties":{"accessibility_features":524416,"assignment_loaded_from_cache":false,"assignment_session_id":"{redacted}","assignment_source":"ready_payload","bucket":0,"client_app_state":"...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"assignment_loaded_from_cache":false,"assignment_session_id":"{redacted}","assignment_source":"ready_payload","bucket":2,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"AWAITING_ENDPOINT","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFHuTiL18z7BJ4BAAAgAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":38,"excluded":false,"exposure_type":"auto","guild_id":"{guild_id}","hash_result":8827,"holdout_name":null,"launch_signature":"{uuid}","location":"VoiceChannelHistoryTracking","location_stack":[],"name":"{redacted_string}","rendered_locale":"en-US","revision":4,"uptime_...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable received: opcode 10
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-c-vtdj\",{\"micros\":0.0}]"],"heartbeat_interval":41250},"op":10,"s":null,"t":null}
  - docs:
...
- probable received: READY
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-c-vtdj\",{\"micros\":309681,\"calls\":[\"id_created\",{\"micros\":1135,\"calls\":[]},\"session_lookup_time\",{\"micros\":279,\"calls\":[]},\"session_lookup_finished\",{\"micros\":15,\"calls\":[]},\"sessions-prd-gcp-us-east1-c-149\",{\"micros\":307582,\"calls\":[\"start_session\",{\"micros\":289854,\"calls\":[\"prd-rpc-547f9f7987-rvx55\",{\"micros\":198385,\"calls\":[\"get_user\",{\"micros\":145776},\"get_guilds\",{\"micros\":13774},\"user_settings_proto\",{\"micros\":1335},\"relationships\",{\"micros\":6708},\"game_relationships\",{\"micros\":13},\"friend_suggestion\",{\"micros\":36},\"connections\",{\"micros\":10},\"serialized_read_states\",{\"micros\":4},\"send_scheduled_deletion_message\",{\"micros\":2},\"sanitize_premium_perks\",{\"micros...
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
...
## Step: Toggle deafen (toggle-deafen)

Actions:

- press / keyboard / ControlOrMeta+Shift+D
- expect-gateway / opcode 4 / sent

HTTP:

- probable: POST /science
  - request shape: sha256:d192cee4c8846740391e19d4f5e50d881007e3ba30ae2b4b758d0a7956c94239
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"AWAITING_ENDPOINT","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFHuTiL18z7BJ4BAAAkAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":42,"launch_signature":"{uuid}","rendered_locale":"en-US","shortcut_combo":"mod+shift+d","shortcut_name":"{redacted_string}","uptime_app":2},"type":"keyboard_shortcut_used"},{"properties":{"accessibility_features":524416,"app_in_focus":true,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"AWAITING_ENDPOINT","client_s...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
