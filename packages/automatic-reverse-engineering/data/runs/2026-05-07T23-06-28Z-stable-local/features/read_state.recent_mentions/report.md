# Feature: Open recent mentions

Run: 2026-05-07T23-06-28Z-stable-local
Scenario: read_state.recent_mentions
...
- probable: GET /users/@me/survey
  ...
  - response sample redacted: {"global":false,"message":"You are being rate limited.","retry_after":83249.385}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- background received: opcode 10
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-d-33k5\",{\"micros\":0.0}]"],"heartbeat_interval":41250},"op":10,"s":null,"t":null}
  - docs:
...
- probable received: READY
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-d-33k5\",{\"micros\":232429,\"calls\":[\"id_created\",{\"micros\":1851,\"calls\":[]},\"session_lookup_time\",{\"micros\":2837,\"calls\":[]},\"session_lookup_finished\",{\"micros\":12,\"calls\":[]},\"sessions-prd-gcp-us-east1-d-112\",{\"micros\":226984,\"calls\":[\"start_session\",{\"micros\":130116,\"calls\":[\"prd-rpc-547f9f7987-2nkt2\",{\"micros\":57077,\"calls\":[\"get_user\",{\"micros\":9048},\"get_guilds\",{\"micros\":16798},\"user_settings_proto\",{\"micros\":37},\"relationships\",{\"micros\":7157},\"game_relationships\",{\"micros\":5},\"friend_suggestion\",{\"micros\":39},\"connections\",{\"micros\":11},\"serialized_read_states\",{\"micros\":4},\"send_scheduled_deletion_message\",{\"micros\":2},\"sanitize_premium_perks\",{\"micros\":2}...
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
...
## Step: Open recent mentions (open-recent-mentions)

Actions:

- click / role:button / options:name
- click / text / value redacted
- expect-network / GET /users/@me/mentions
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFHfF5lwdnGBJ4BAAAWAAAA","client_viewport_height":720,"client_viewport_width":1280,"error_message":"You are being rate limited.","event_sequence_number":28,"launch_signature":"{uuid}","rendered_locale":"en-US","request_method":"get","status_code":429,"uptime_app":2,"url":"{redacted_string}"},"type":"network_action_user_survey_fetch"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:7b3883585e729d0f848ba90bf8fb506d195dec1b7e92764be751494ba19e2dcb
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFHfF5lwdnGBJ4BAAAZAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":31,"launch_signature":"{uuid}","rendered_locale":"en-US","type":"Inbox","uptime_app":3},"type":"open_popout"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:7b3883585e729d0f848ba90bf8fb506d195dec1b7e92764be751494ba19e2dcb
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFHfF5lwdnGBJ4BAAAaAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":32,"launch_signature":"{uuid}","rendered_locale":"en-US","type":"Recent Mentions","uptime_app":3},"type":"open_popout"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"assignment_loaded_from_cache":false,"assignment_session_id":"{redacted}","assignment_source":"ready_payload","bucket":1,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFHfF5lwdnGBJ4BAAAbAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":33,"excluded":false,"exposure_type":"manual","guild_id":"{guild_id}","hash_result":5093,"holdout_name":null,"launch_signature":"{uuid}","location":"GuildPowerupsManager","location_stack":[],"name":"{redacted_string}","rendered_locale":"en-US","revision":2,"uptime_app":3},"t...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
