# Feature: Search guild members

Run: 2026-05-07T23-06-28Z-stable-local
Scenario: search.member.basic
...
- probable: GET /users/@me/survey
  ...
  - response sample redacted: {"global":false,"message":"You are being rate limited.","retry_after":81411.561}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- background received: opcode 10
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-d-2dcv\",{\"micros\":0.0}]"],"heartbeat_interval":41250},"op":10,"s":null,"t":null}
  - docs:
...
- probable received: READY
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-d-2dcv\",{\"micros\":179516,\"calls\":[\"id_created\",{\"micros\":1659,\"calls\":[]},\"session_lookup_time\",{\"micros\":9721,\"calls\":[]},\"session_lookup_finished\",{\"micros\":15,\"calls\":[]},\"sessions-prd-gcp-us-east1-d-90\",{\"micros\":167463,\"calls\":[\"start_session\",{\"micros\":126164,\"calls\":[\"prd-rpc-547f9f7987-22hnm\",{\"micros\":58289,\"calls\":[\"get_user\",{\"micros\":7950},\"get_guilds\",{\"micros\":22523},\"user_settings_proto\",{\"micros\":39},\"relationships\",{\"micros\":12},\"game_relationships\",{\"micros\":2},\"friend_suggestion\",{\"micros\":31},\"connections\",{\"micros\":10},\"serialized_read_states\",{\"micros\":12},\"send_scheduled_deletion_message\",{\"micros\":2},\"sanitize_premium_perks\",{\"micros\":1},\...
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
...
## Step: Search members (search-members)

Actions:

- click / role:textbox / options:name
- type / keyboard / value redacted
- expect-gateway / opcode 8 / sent
- expect-gateway / GUILD_MEMBERS_CHUNK / received
- press / keyboard / ControlOrMeta+A
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBEZ7KE0CuXiBJ4BAAAWAAAA","client_viewport_height":720,"client_viewport_width":1280,"error_message":"You are being rate limited.","event_sequence_number":28,"launch_signature":"{uuid}","rendered_locale":"en-US","request_method":"get","status_code":429,"uptime_app":2,"url":"{redacted_string}"},"type":"network_action_user_survey_fetch"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
- probable: POST /science
  - request shape: sha256:ec9ede33b1eab2bae920e5495786a5bff8e0ef6d14858a42b733926f03139b09
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"autocomplete_type":"MENTIONS","channel_hidden":false,"channel_id":"{channel_id}","channel_member_perms":"{snowflake}","channel_size_total":0,"channel_type":0,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBEZ7KE0CuXiBJ4BAAAZAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":31,"guild_id":"{guild_id}","guild_is_vip":false,"guild_member_num_roles":0,"guild_member_perms":"{snowflake}","guild_num_channels":4,"guild_num_roles":3,"guild_num_text_channels":3,"guild_num_voice_channels":1,"guild_size_total":2,"is_m...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- direct sent: opcode 8
  ...
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
- direct received: GUILD_MEMBERS_CHUNK
