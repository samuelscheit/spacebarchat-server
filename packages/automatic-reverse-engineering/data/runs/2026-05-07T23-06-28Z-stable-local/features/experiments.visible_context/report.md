# Feature: Record startup experiment and feature context

Run: 2026-05-07T23-06-28Z-stable-local
Scenario: experiments.visible_context
...
## Step: Load startup experiment context (load-experiment-context)

Actions:

- goto-channel / fixture-channel:general
- expect-ready
- expect-gateway / READY / received
- expect-gateway / READY_SUPPLEMENTAL / received
...
- probable received: opcode 10
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-d-h8hk\",{\"micros\":0.0}]"],"heartbeat_interval":41250},"op":10,"s":null,"t":null}
  - docs:
...
- direct received: READY
  - payload shape: sha256:dfc896860c88ec20852d5bde6b6b1ac74ecb53619cadf011e85849675270fb69
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-d-h8hk\",{\"micros\":215674,\"calls\":[\"id_created\",{\"micros\":1133,\"calls\":[]},\"session_lookup_time\",{\"micros\":348,\"calls\":[]},\"session_lookup_finished\",{\"micros\":11,\"calls\":[]},\"sessions-prd-gcp-us-east1-d-196\",{\"micros\":213075,\"calls\":[\"start_session\",{\"micros\":147776,\"calls\":[\"prd-rpc-547f9f7987-778cq\",{\"micros\":55599,\"calls\":[\"get_user\",{\"micros\":6717},\"get_guilds\",{\"micros\":18195},\"user_settings_proto\",{\"micros\":1024},\"relationships\",{\"micros\":3678},\"game_relationships\",{\"micros\":4},\"friend_suggestion\",{\"micros\":36},\"connections\",{\"micros\":10},\"serialized_read_states\",{\"micros\":3},\"send_scheduled_deletion_message\",{\"micros\":2},\"sanitize_premium_perks\",{\"micros\":2...
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
- direct received: READY_SUPPLEMENTAL
