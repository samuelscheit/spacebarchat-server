# Feature: Create a public thread from a message

Run: 2026-05-07T23-06-28Z-stable-local
Scenario: thread.create.basic
...
- probable: GET /channels/{channel_id}
  ...
  - response sample redacted: {"flags":0,"guild_id":"{guild_id}","icon_emoji":{"id":null,"name":"{redacted_string}"},"id":"{channel_id}","last_message_id":"{snowflake}","last_pin_timestamp":"{phone}T00:14:{phone}+00:00","name":"{redacted_string}","nsfw":false,"parent_id":"{snowflake}","permission_overwrites":[],"position":0,"rate_limit_per_user":0,"theme_color":null,"topic":null,"type":0}
  - docs:
...
- probable: GET /users/@me/survey
  ...
  - response sample redacted: {"global":false,"message":"You are being rate limited.","retry_after":80010.052}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBHj5T+wsUn4BJ4BAAAKAAAA","client_viewport_height":720,"client_viewport_width":1280,"evaluation_id":"61f72003","event_sequence_number":16,"experiment":"2026-03-file-upload-powerup-holdout","exposure_location":"GuildPowerupsConstants","launch_signature":"{uuid}","rendered_locale":"en-US","tracked_variation_id":0,"unit_type":"user","uptime_app":1},"type":"experiment_user_evaluation_exposed"},{"properties":{"accessibility_features":524416,"assignment_loaded_from_cache":false,"assignment_session_id":"{...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable received: opcode 10
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-d-5wbg\",{\"micros\":0.0}]"],"heartbeat_interval":41250},"op":10,"s":null,"t":null}
  - docs:
...
- probable received: READY
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-d-5wbg\",{\"micros\":296356,\"calls\":[\"id_created\",{\"micros\":1221,\"calls\":[]},\"session_lookup_time\",{\"micros\":5682,\"calls\":[]},\"session_lookup_finished\",{\"micros\":14,\"calls\":[]},\"sessions-prd-gcp-us-east1-d-199\",{\"micros\":288336,\"calls\":[\"start_session\",{\"micros\":274627,\"calls\":[\"prd-rpc-547f9f7987-62qxf\",{\"micros\":122023,\"calls\":[\"get_user\",{\"micros\":6972},\"get_guilds\",{\"micros\":24978},\"user_settings_proto\",{\"micros\":40},\"relationships\",{\"micros\":11678},\"game_relationships\",{\"micros\":17},\"friend_suggestion\",{\"micros\":38},\"connections\",{\"micros\":14},\"serialized_read_states\",{\"micros\":6},\"send_scheduled_deletion_message\",{\"micros\":3},\"sanitize_premium_perks\",{\"micros\"...
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
- probable received: READY_SUPPLEMENTAL
  ...
  - payload sample redacted: {"d":{"disclose":["pomelo"],"game_invites":[],"guilds":[{"activity_instances":[],"embedded_activities":[],"id":"{guild_id}","voice_states":[]},{"activity_instances":[],"embedded_activities":[],"id":"{guild_id}","voice_states":[]}],"lazy_private_channels":[],"merged_members":[[],[]],"merged_presences":{"friends":[{"activities":[{"content_classification":{"data":null,"loaded":true},"created_at":"{timestamp}","id":"custom","name":"{redacted_string}","state":"samuelscheit.com","type":4}],"client_status":{"web":"online"},"hidden_activities":[],"processed_at_timestamp":"{timestamp}","restricted_application":null,"status":"online","user_id":"{snowflake}"}],"guilds":[[],[]]},"user_activities":[]},"op":0,"s":2,"t":"READY_SUPPLEMENTAL"}
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
...
## Step: Send source message for thread (seed-thread-source-message)

Actions:

- fill / role:textbox / options:name / value redacted
...
- direct: POST /channels/{channel_id}/messages
  ...
  - response sample redacted: {"attachments":[],"author":"{redacted}","channel_id":"{channel_id}","components":[],"content":"{redacted_string}","edited_timestamp":null,"embeds":[],"flags":0,"id":"{snowflake}","mention_everyone":false,"mention_roles":[],"mentions":[],"nonce":"{snowflake}","pinned":false,"timestamp":"{phone}T00:24:{phone}+00:00","tts":false,"type":0}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBHj5T+wsUn4BJ4BAAAWAAAA","client_viewport_height":720,"client_viewport_width":1280,"error_message":"You are being rate limited.","event_sequence_number":28,"launch_signature":"{uuid}","rendered_locale":"en-US","request_method":"get","status_code":429,"uptime_app":1,"url":"{redacted_string}"},"type":"network_action_user_survey_fetch"},{"properties":{"accessibility_features":524416,"bypass_fatigue":true,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memor...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"app_hardware_acceleration_enabled":true,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBHj5T+wsUn4BJ4BAAAYAAAA","client_viewport_height":720,"client_viewport_width":1280,"css_compressed_byte_size":472318,"css_transfer_byte_size":0,"css_uncompressed_byte_size":3215373,"duration_ms_since_app_opened":4303,"event_sequence_number":30,"js_compressed_byte_size":517442,"js_transfer_byte_size":0,"js_uncompressed_byte_size":2097545,"launch_signature":"{uuid}","load_id":"{uuid}","rendered_locale":"en-US","screen_name":"{redacted_string}","total_compress...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: GET /content-inventory/users/@me
  ...
  - response sample redacted: {"entries":[],"entries_hash":0,"expired_at":"{phone}T00:34:{phone}+00:00","refresh_stale_inbox_after_ms":30000,"refresh_token":"{redacted}","request_id":"087f0d2732404cc79596eea9fd28d873","unranked_game_entries":[],"wait_ms_until_next_fetch":616322}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
- probable: GET /games/detectable/exclusions
  ...
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
- probable: GET /guilds/{guild_id}/application-command-index
  - status codes: 200
  - response shape: sha256:8cf28dd4520841abe1db5524a7a226727f3119f655256b458cb23c5cbd13df0c
  - response sample redacted: {"application_commands":[],"applications":[{"bot_id":"{user_id}","description":"{redacted_string}","flags":"565248","id":"{user_id}","name":"{redacted_string}"}]}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: GET /store/published-listings/skus
  ...
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
- probable: GET /users/@me/application-command-index
  - status codes: 200
  - response shape: sha256:533eaa5ca6bc75b3fdf6e6273a7e111b6c01018a69cb83c4ff5fb813ab34deba
  - response sample redacted: {"application_commands":[{"application_id":"{snowflake}","contexts":[0,1,2],"description":"{redacted_string}","dm_permission":true,"handler":1,"id":"{snowflake}","integration_types":[0,1],"name":"{redacted_string}","type":4,"version":"{snowflake}"},{"application_id":"{snowflake}","contexts":[0,1,2],"description":"{redacted_string}","dm_permission":true,"global_popularity_rank":1,"id":"{snowflake}","integration_types":[0,1],"name":"{redacted_string}","type":1,"version":"{snowflake}"}],"applications":[{"bot_id":"{user_id}","description":"{redacted_string}","flags":"565248","id":"{user_id}","name":"{redacted_string}"},{"bot_id":"{snowflake}","description":"{redacted_string}","embedded_activity_config":{"supported_platforms":["web","ios","android"]},"flags":"28442626","icon":"{redacted_stri...
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- probable: GET /users/@me/settings-proto/2
  ...
  - response sample redacted: {"settings":""}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
- direct: POST /channels/{channel_id}/messages/{message_id}/threads
  - status codes: 201
  - request shape: sha256:28afe38e7c73cfb4703ebc7ca2fbb8bb7403dd6a8633e0aa75aa296c2b2ce07c
  - request sample redacted: {"auto_archive_duration":4320,"location":"Message","name":"{redacted_string}","type":11}
  - response shape: sha256:c6c44b34835127a1a25d4c3de2793af79cfe75dbb286f65c540fab88bb09c833
  - response sample redacted: {"bitrate":64000,"flags":0,"guild_id":"{guild_id}","id":"{snowflake}","last_message_id":"{snowflake}","member":{"flags":1,"id":"{snowflake}","join_timestamp":"{phone}T00:24:{phone}+00:00","mute_config":null,"muted":false,"user_id":"{user_id}"},"member_count":1,"member_ids_preview":["{user_id}"],"message_count":0,"name":"{redacted_string}","owner_id":"{user_id}","parent_id":"{channel_id}","rate_limit_per_user":0,"rtc_region":null,"thread_metadata":{"archive_timestamp":"{phone}T00:24:{phone}+00:00","archived":false,"auto_archive_duration":4320,"create_timestamp":"{phone}T00:24:{phone}+00:00","locked":false},"total_message_sent":0,"type":11,"user_limit":0}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"assignment_loaded_from_cache":false,"assignment_session_id":"{redacted}","assignment_source":"ready_payload","bucket":1,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBHj5T+wsUn4BJ4BAAAZAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":31,"excluded":false,"exposure_type":"manual","guild_id":"{guild_id}","hash_result":5093,"holdout_name":null,"launch_signature":"{uuid}","location":"GuildPowerupsManager","location_stack":[],"name":"{redacted_string}","rendered_locale":"en-US","revision":2,"uptime_app":2},"t...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBHj5T+wsUn4BJ4BAAAgAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":38,"launch_signature":"{uuid}","received_etag":"W/\"2e044f14966184cddd86e64f71cce135\"","rendered_locale":"en-US","request_method":"get","sent_etag":"","status_code":200,"uptime_app":2,"url":"{redacted_string}"},"type":"network_action_detectable_non_games_fetch"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:898da5a70cb941bec753b1ce62138806176cd197b5575e69ea89bd793712f268
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"channel":"{channel_id}","client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBHj5T+wsUn4BJ4BAAAhAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":39,"launch_signature":"{uuid}","location":"right_click","message_id":"{snowflake}","rendered_locale":"en-US","uptime_app":3},"type":"message_popout_menu_opened_desktop"},{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_time...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"assignment_loaded_from_cache":false,"assignment_session_id":"{redacted}","assignment_source":"ready_payload","bucket":1,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBHj5T+wsUn4BJ4BAAAjAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":41,"excluded":false,"exposure_type":"auto_fallback","guild_id":"{guild_id}","hash_result":5093,"holdout_name":null,"launch_signature":"{uuid}","location":"maybeGetGameServerHostingGuildEligiblePopoutDCF","location_stack":[],"name":"{redacted_string}","rendered_locale":"en-U...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
- probable: POST /science
  - request shape: sha256:4d80c27e62663fb99eb6d0188556197b323233de62d636e5a5f429928e8d52f0
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBHj5T+wsUn4BJ4BAAAkAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":42,"launch_signature":"{uuid}","miss":true,"rendered_locale":"en-US","size":0,"uptime_app":3},"type":"application_command_cache_fetch"},{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}"...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:d9c3d3bc9c0f1da56c254f63a2fa60df40acb8e0c9c84fa28134ffe1424db523
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"channel_id":"{channel_id}","client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBHj5T+wsUn4BJ4BAAAmAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":44,"guild_id":"{guild_id}","launch_signature":"{uuid}","message_id":"{snowflake}","rendered_locale":"en-US","time_to_close_ms":107,"uptime_app":3},"type":"message_menu_time_to_close"},{"properties":{"accessibility_features":524416,"channel_id":"{channel_id}","client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"clien...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:40b8c68c994822006202ad9631efc5bc4f75050792a48cd97209f9e7aeab54aa
  - request sample redacted: {"events":[{"properties":{"aborted":false,"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBHj5T+wsUn4BJ4BAAApAAAA","client_viewport_height":720,"client_viewport_width":1280,"command_type":null,"duration_ms":230.2999999821186,"error":false,"event_sequence_number":47,"failure_statuses":[],"include_applications":true,"kind":null,"launch_signature":"{uuid}","rendered_locale":"en-US","retries":0,"target_id":null,"target_type":"user","uptime_app":3,"url":"{redacted_string}"},"type":"application_command_performance"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:2b036d3ab1be43dbe10248834017c8e0a5d19a9d62d95e02c1708cc4521c1c01
  - request sample redacted: {"events":[{"properties":{"aborted":false,"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBHj5T+wsUn4BJ4BAAAqAAAA","client_viewport_height":720,"client_viewport_width":1280,"command_type":null,"duration_ms":320.59999999403954,"error":false,"event_sequence_number":48,"failure_statuses":[],"include_applications":true,"kind":null,"launch_signature":"{uuid}","rendered_locale":"en-US","retries":0,"target_id":"{guild_id}","target_type":"guild","uptime_app":3,"url":"{redacted_string}"},"type":"application_command_performance"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable received: GUILD_AUDIT_LOG_ENTRY_CREATE
  - payload shape: sha256:3731104437d34d99a216b30525e771030c98f260fc73d038e7d874e0993137e5
  - payload sample redacted: {"d":{"action_type":110,"changes":[{"key":"name","new_value":"dm-thread-{phone}T23-06-28Z-stable-local-{phone}"},{"key":"type","new_value":11},{"key":"archived","new_value":false},{"key":"locked","new_value":false},{"key":"auto_archive_duration","new_value":4320},{"key":"rate_limit_per_user","new_value":0},{"key":"flags","new_value":0}],"guild_id":"{guild_id}","id":"{snowflake}","target_id":"{snowflake}","user_id":"{user_id}"},"op":0,"s":15,"t":"GUILD_AUDIT_LOG_ENTRY_CREATE"}
- probable received: MESSAGE_CREATE
  - payload shape: sha256:fb08785a6773e700da0e09a0b6fdca6b88fae8512a5861918cfd56026b5527d9
  - payload sample redacted: {"d":{"attachments":[],"author":"{redacted}","channel_id":"{snowflake}","channel_type":11,"components":[],"content":"{redacted_string}","edited_timestamp":null,"embeds":[],"flags":0,"guild_id":"{guild_id}","id":"{snowflake}","member":{"avatar":null,"banner":null,"communication_disabled_until":null,"deaf":false,"flags":0,"joined_at":"{phone}T09:12:{phone}+00:00","mute":false,"nick":null,"pending":false,"premium_since":null,"roles":[]},"mention_everyone":false,"mention_roles":[],"mentions":[],"message_reference":{"channel_id":"{channel_id}","guild_id":"{guild_id}","message_id":"{snowflake}","type":0},"pinned":false,"position":0,"timestamp":"{phone}T00:24:{phone}+00:00","tts":false,"type":21},"op":0,"s":14,"t":"MESSAGE_CREATE"}
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
- probable received: MESSAGE_UPDATE
  - payload shape: sha256:b852fb524c6889f27ffa4ce8a266186beefe2c1685cfddf916f1a514bcd8e691
  - payload sample redacted: {"d":{"attachments":[],"author":"{redacted}","channel_id":"{channel_id}","channel_type":0,"components":[],"content":"{redacted_string}","edited_timestamp":null,"embeds":[],"flags":32,"guild_id":"{guild_id}","id":"{snowflake}","member":{"avatar":null,"banner":null,"communication_disabled_until":null,"deaf":false,"flags":0,"joined_at":"{phone}T09:12:{phone}+00:00","mute":false,"nick":null,"pending":false,"premium_since":null,"roles":[]},"mention_everyone":false,"mention_roles":[],"mentions":[],"pinned":false,"timestamp":"{phone}T00:24:{phone}+00:00","tts":false,"type":0},"op":0,"s":11,"t":"MESSAGE_UPDATE"}
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
- probable received: PRESENCE_UPDATE
  - payload shape: sha256:100c18bdf673c7bd261322feda96e814d2eeb5ee3e4774288f14d33a87652e3b
  - payload sample redacted: {"d":{"activities":[{"content_classification":{"data":null,"loaded":true},"created_at":"{timestamp}","id":"custom","name":"{redacted_string}","state":"samuelscheit.com","type":4}],"client_status":{"web":"idle"},"hidden_activities":[],"processed_at_timestamp":"{timestamp}","restricted_application":null,"status":"idle","user":{"avatar":"{redacted_string}","avatar_decoration_data":null,"bot":false,"clan":null,"collectibles":null,"discriminator":"0","display_name_styles":null,"global_name":"{redacted_string}","id":"{snowflake}","primary_guild":null,"public_flags":64,"username":"{redacted_string}"}},"op":0,"s":10,"t":"PRESENCE_UPDATE"}
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
  - static candidates:
    - high / fast-connect.38fb8ec2baeaa13d.js / module QUEST_PREVIEW_TOOL_2
- direct received: THREAD_CREATE
  - payload shape: sha256:a01706c5c1052b2b90b3c77dafb7467d4e54b1c0e29a37cbef221b0aeb5b2a59
  - payload sample redacted: {"d":{"flags":0,"guild_id":"{guild_id}","id":"{snowflake}","last_message_id":null,"member_count":1,"member_ids_preview":["{user_id}"],"message_count":0,"name":"{redacted_string}","newly_created":true,"owner_id":"{user_id}","parent_id":"{channel_id}","rate_limit_per_user":0,"thread_metadata":{"archive_timestamp":"{phone}T00:24:{phone}+00:00","archived":false,"auto_archive_duration":4320,"create_timestamp":"{phone}T00:24:{phone}+00:00","locked":false},"total_message_sent":0,"type":11},"op":0,"s":12,"t":"THREAD_CREATE"}
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
- probable received: THREAD_MEMBER_UPDATE
  - payload shape: sha256:34234a41520f5e5f8ef25fa5ffee9c944376ae4f690b838426a5da719d63219b
  - payload sample redacted: {"d":{"flags":1,"guild_id":"{guild_id}","id":"{snowflake}","join_timestamp":"{phone}T00:24:{phone}+00:00","mute_config":null,"muted":false,"user_id":"{user_id}"},"op":0,"s":13,"t":"THREAD_MEMBER_UPDATE"}
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
