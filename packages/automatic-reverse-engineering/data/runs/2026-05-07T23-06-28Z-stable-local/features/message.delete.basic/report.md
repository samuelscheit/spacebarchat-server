...
- probable: GET /users/@me/survey
  ...
  - response sample redacted: {"global":false,"message":"You are being rate limited.","retry_after":80840.744}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- probable received: opcode 10
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-d-q5tk\",{\"micros\":0.0}]"],"heartbeat_interval":41250},"op":10,"s":null,"t":null}
  - docs:
...
- probable received: READY
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-d-q5tk\",{\"micros\":167882,\"calls\":[\"id_created\",{\"micros\":1171,\"calls\":[]},\"session_lookup_time\",{\"micros\":9016,\"calls\":[]},\"session_lookup_finished\",{\"micros\":18,\"calls\":[]},\"sessions-prd-gcp-us-east1-d-18\",{\"micros\":156583,\"calls\":[\"start_session\",{\"micros\":140448,\"calls\":[\"prd-rpc-547f9f7987-n6ggp\",{\"micros\":60156,\"calls\":[\"get_user\",{\"micros\":7646},\"get_guilds\",{\"micros\":21592},\"user_settings_proto\",{\"micros\":38},\"relationships\",{\"micros\":10},\"game_relationships\",{\"micros\":3},\"friend_suggestion\",{\"micros\":27},\"connections\",{\"micros\":11},\"serialized_read_states\",{\"micros\":5},\"send_scheduled_deletion_message\",{\"micros\":2},\"sanitize_premium_perks\",{\"micros\":2},\"...
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
...
## Step: Delete message (delete-message)
...
- expect-network / DELETE /channels/{channel_id}/messages/{message_id}
- expect-gateway / MESSAGE_DELETE / received

HTTP:

- direct: DELETE /channels/{channel_id}/messages/{message_id}
  - status codes: 204
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
...
- probable: GET /content-inventory/users/@me
  ...
  - response sample redacted: {"entries":[],"entries_hash":0,"expired_at":"{phone}T00:24:{phone}+00:00","refresh_stale_inbox_after_ms":30000,"refresh_token":"{redacted}","request_id":"576e1f6036c74e599ce7a55c9bc94d74","unranked_game_entries":[],"wait_ms_until_next_fetch":846174}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- probable: GET /quests/decision
  ...
  - response sample redacted: {"ad_context":null,"ad_identifiers":null,"creative":null,"metadata_sealed":"...
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- probable: GET /users/@me/settings-proto/2
  ...
  - response sample redacted: {"settings":""}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFpIjIvVZ7rBJ4BAAAWAAAA","client_viewport_height":720,"client_viewport_width":1280,"error_message":"You are being rate limited.","event_sequence_number":28,"launch_signature":"{uuid}","rendered_locale":"en-US","request_method":"get","status_code":429,"uptime_app":1,"url":"{redacted_string}"},"type":"network_action_user_survey_fetch"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"assignment_loaded_from_cache":false,"assignment_session_id":"{redacted}","assignment_source":"ready_payload","bucket":1,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFpIjIvVZ7rBJ4BAAAZAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":31,"excluded":false,"exposure_type":"manual","guild_id":"{guild_id}","hash_result":5093,"holdout_name":null,"launch_signature":"{uuid}","location":"GuildPowerupsManager","location_stack":[],"name":"{redacted_string}","rendered_locale":"en-US","revision":2,"uptime_app":2},"t...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFpIjIvVZ7rBJ4BAAAgAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":38,"launch_signature":"{uuid}","received_etag":"W/\"2e044f14966184cddd86e64f71cce135\"","rendered_locale":"en-US","request_method":"get","sent_etag":"","status_code":200,"uptime_app":2,"url":"{redacted_string}"},"type":"network_action_detectable_non_games_fetch"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:c0b0f62c0027f5505f261208d646670fc4bf627706b89d7d0cdd0413006ac145
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"assignment_loaded_from_cache":false,"assignment_session_id":"{redacted}","assignment_source":"ready_payload","bucket":1,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFpIjIvVZ7rBJ4BAAAhAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":39,"excluded":false,"exposure_type":"auto_fallback","guild_id":"{guild_id}","hash_result":5093,"holdout_name":null,"launch_signature":"{uuid}","location":"maybeGetGameServerHostingGuildEligiblePopoutDCF","location_stack":[],"name":"{redacted_string}","rendered_locale":"en-U...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:4a54b4032616d3d384ef0cb2cd1787ec5ec92541c9364fd14fbbf1fc7cf2dad7
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFpIjIvVZ7rBJ4BAAAiAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":40,"launch_signature":"{uuid}","received_etag":"W/\"5b47f{phone}bdd4135c560c3144\"","rendered_locale":"en-US","request_method":"get","sent_etag":"","status_code":200,"uptime_app":3,"url":"{redacted_string}"},"type":"network_action_detectable_applications_fetch"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"channel_id":"{channel_id}","client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFpIjIvVZ7rBJ4BAAAmAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":44,"guild_id":"{guild_id}","launch_signature":"{uuid}","message_id":"{message_id}","rendered_locale":"en-US","time_to_close_ms":114,"uptime_app":4},"type":"message_menu_time_to_close"},{"properties":{"accessibility_features":524416,"channel_id":"{channel_id}","client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"clie...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:4bfcef009750ddaaa16e6e21624988d5b1e3e0e401cfcf0e28b36b9af210c32f
  - request sample redacted: {"events":[{"properties":{"aborted":false,"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFpIjIvVZ7rBJ4BAAAoAAAA","client_viewport_height":720,"client_viewport_width":1280,"command_type":null,"duration_ms":197.09999999403954,"error":false,"event_sequence_number":46,"failure_statuses":[],"include_applications":true,"kind":null,"launch_signature":"{uuid}","rendered_locale":"en-US","retries":0,"target_id":null,"target_type":"user","uptime_app":4,"url":"{redacted_string}"},"type":"application_command_performance"},{"properties":{"aborted":false,"accessibility_features":524...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable received: GUILD_MEMBERS_CHUNK
  ...
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
- direct received: MESSAGE_DELETE
  - payload shape: sha256:8dd2faa153ae6171ee9a9eef157f150b67e3c4c5a3af957ef29a55efc8da4b74
  - payload sample redacted: {"d":{"channel_id":"{channel_id}","guild_id":"{guild_id}","id":"{message_id}"},"op":0,"s":9,"t":"MESSAGE_DELETE"}
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
