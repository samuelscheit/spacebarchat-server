# Feature: Edit a plain text message

Run: 2026-05-07T23-06-28Z-stable-local
Scenario: message.edit.basic
...
- probable: GET /users/@me/survey
  ...
  - response sample redacted: {"global":false,"message":"You are being rate limited.","retry_after":80858.591}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFQ1L4h5FLrBJ4BAAAKAAAA","client_viewport_height":720,"client_viewport_width":1280,"evaluation_id":"61f72003","event_sequence_number":16,"experiment":"2026-03-file-upload-powerup-holdout","exposure_location":"GuildPowerupsConstants","launch_signature":"{uuid}","rendered_locale":"en-US","tracked_variation_id":0,"unit_type":"user","uptime_app":1},"type":"experiment_user_evaluation_exposed"},{"properties":{"accessibility_features":524416,"assignment_loaded_from_cache":false,"assignment_session_id":"{...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable received: opcode 10
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-b-lrzm\",{\"micros\":0.0}]"],"heartbeat_interval":41250},"op":10,"s":null,"t":null}
  - docs:
...
- probable received: READY
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-b-lrzm\",{\"micros\":260165,\"calls\":[\"id_created\",{\"micros\":1545,\"calls\":[]},\"session_lookup_time\",{\"micros\":2697,\"calls\":[]},\"session_lookup_finished\",{\"micros\":14,\"calls\":[]},\"sessions-prd-gcp-us-east1-b-29\",{\"micros\":255238,\"calls\":[\"start_session\",{\"micros\":222588,\"calls\":[\"prd-rpc-547f9f7987-m2x6p\",{\"micros\":81152,\"calls\":[\"get_user\",{\"micros\":20216},\"get_guilds\",{\"micros\":23254},\"user_settings_proto\",{\"micros\":1360},\"relationships\",{\"micros\":4107},\"game_relationships\",{\"micros\":5},\"friend_suggestion\",{\"micros\":56},\"connections\",{\"micros\":14},\"serialized_read_states\",{\"micros\":16},\"send_scheduled_deletion_message\",{\"micros\":3},\"sanitize_premium_perks\",{\"micros\"...
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
...
## Step: Edit message (edit-message)
...
- expect-network / PATCH /channels/{channel_id}/messages/{message_id}
- expect-gateway / MESSAGE_UPDATE / received
...
- probable: GET /content-inventory/users/@me
  ...
  - response sample redacted: {"entries":[],"entries_hash":0,"expired_at":"{phone}T00:24:{phone}+00:00","refresh_stale_inbox_after_ms":30000,"refresh_token":"{redacted}","request_id":"ee57fb6f79044cb6b1d35a0ca42b81f6","unranked_game_entries":[],"wait_ms_until_next_fetch":865335}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- probable: GET /users/@me/settings-proto/2
  ...
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
- direct: PATCH /channels/{channel_id}/messages/{message_id}
  - status codes: 200
  - request shape: sha256:316dbe44274171ebbf653c8a3a9073c9a660ec4d1b11877f285ac8a64747f419
  - request sample redacted: {"content":"{redacted_string}"}
  - response shape: sha256:51f245f5cebd7ae7bec369f817039b8dfca89655dd5f8e66af96bf06e94dd116
  - response sample redacted: {"attachments":[],"author":"{redacted}","channel_id":"{channel_id}","components":[],"content":"{redacted_string}","edited_timestamp":"{phone}T00:09:{phone}+00:00","embeds":[],"flags":0,"id":"{message_id}","mention_everyone":false,"mention_roles":[],"mentions":[],"pinned":false,"timestamp":"{phone}T23:07:{phone}+00:00","tts":false,"type":0}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFQ1L4h5FLrBJ4BAAAWAAAA","client_viewport_height":720,"client_viewport_width":1280,"error_message":"You are being rate limited.","event_sequence_number":28,"launch_signature":"{uuid}","rendered_locale":"en-US","request_method":"get","status_code":429,"uptime_app":3,"url":"{redacted_string}"},"type":"network_action_user_survey_fetch"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"bypass_fatigue":true,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFQ1L4h5FLrBJ4BAAAXAAAA","client_viewport_height":720,"client_viewport_width":1280,"content_count":1,"event_sequence_number":29,"fatigable_content_count":1,"guild_id":"{guild_id}","launch_signature":"{uuid}","rendered_locale":"en-US","type":"FIRST_BOOSTER_UPSELL_OVERSEER","uptime_app":3},"type":"dismissible_content_shown"},{"properties":{"accessibility_features":524416,"app_hardware_acceleration_enabled":true,"client_app_state":"focused","client_heartbeat_session_id":"{redact...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFQ1L4h5FLrBJ4BAAAkAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":42,"launch_signature":"{uuid}","miss":true,"rendered_locale":"en-US","size":0,"uptime_app":4},"type":"application_command_cache_fetch"},{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}"...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"channel_id":"{channel_id}","client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFQ1L4h5FLrBJ4BAAAmAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":44,"guild_id":"{guild_id}","launch_signature":"{uuid}","message_id":"{message_id}","rendered_locale":"en-US","time_to_close_ms":52,"uptime_app":4},"type":"message_menu_time_to_close"},{"properties":{"accessibility_features":524416,"channel_id":"{channel_id}","client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"clien...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
