...
Scenario: channel.permission.edit
...
## Step: Open channel permission settings (open-channel-settings)
...
- probable: GET /channels/{channel_id}
  ...
  - response sample redacted: {"flags":0,"guild_id":"{guild_id}","icon_emoji":{"id":null,"name":"{redacted_string}"},"id":"{channel_id}","last_message_id":"{snowflake}","last_pin_timestamp":"{phone}T00:14:{phone}+00:00","name":"{redacted_string}","nsfw":false,"parent_id":"{snowflake}","permission_overwrites":[{"allow":"0","deny":"2048","id":"{guild_id}","type":0}],"position":0,"rate_limit_per_user":0,"theme_color":null,"topic":null,"type":0}
  - docs:
...
- probable: GET /guilds/{guild_id}/integrations
  ...
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
- probable: GET /guilds/{guild_id}/regions
  - status codes: 200
  - response shape: sha256:c19dbb477a86f084455069aa48b9a492fd3d741fbff9e5de1fba43d83293e43b
  - response sample redacted: [{"custom":false,"deprecated":false,"id":"brazil","name":"{redacted_string}","optimal":false},{"custom":false,"deprecated":false,"id":"hongkong","name":"{redacted_string}","optimal":false},{"custom":false,"deprecated":false,"id":"india","name":"{redacted_string}","optimal":false},{"custom":false,"deprecated":false,"id":"japan","name":"{redacted_string}","optimal":false},{"custom":false,"deprecated":false,"id":"rotterdam","name":"{redacted_string}","optimal":false},{"custom":false,"deprecated":false,"id":"singapore","name":"{redacted_string}","optimal":false},{"custom":false,"deprecated":false,"id":"southafrica","name":"{redacted_string}","optimal":false},{"custom":false,"deprecated":false,"id":"sydney","name":"{redacted_string}","optimal":false},{"custom":false,"deprecated":false,"id":"...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: GET /users/@me/survey
  ...
  - response sample redacted: {"global":false,"message":"You are being rate limited.","retry_after":79222.962}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:d5e330c30b2e7560912a13b9bdcbdf8bc85aae3399d562bf4a3bf280dc6a019e
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBEbDFiMeEwEBZ4BAAAWAAAA","client_viewport_height":720,"client_viewport_width":1280,"error_message":"You are being rate limited.","event_sequence_number":28,"launch_signature":"{uuid}","rendered_locale":"en-US","request_method":"get","status_code":429,"uptime_app":1,"url":"{redacted_string}"},"type":"network_action_user_survey_fetch"},{"properties":{"accessibility_features":524416,"bypass_fatigue":true,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memor...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:dd56609e783c8c0880b8ffbcc759c0f0408a44296d2befa417448a846d13dc10
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"channel_hidden":false,"channel_id":"{channel_id}","channel_member_perms":"{snowflake}","channel_size_total":0,"channel_type":0,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBEbDFiMeEwEBZ4BAAAZAAAA","client_viewport_height":720,"client_viewport_width":1280,"destination_pane":"OVERVIEW","event_sequence_number":31,"guild_id":"{guild_id}","guild_is_vip":false,"guild_member_num_roles":0,"guild_member_perms":"{snowflake}","guild_num_channels":4,"guild_num_roles":3,"guild_num_text_channels":3,"guild_num_voice_channels":1,"guild_size_total":2,"is_me...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:855b48d566969c98c0c0038b8eeb655ed3b9d3548956925eacdc5d1b5fdcfc2d
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"channel_hidden":false,"channel_id":"{channel_id}","channel_member_perms":"{snowflake}","channel_size_total":0,"channel_type":0,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBEbDFiMeEwEBZ4BAAAaAAAA","client_viewport_height":720,"client_viewport_width":1280,"destination_pane":"PERMISSIONS","event_sequence_number":32,"guild_id":"{guild_id}","guild_is_vip":false,"guild_member_num_roles":0,"guild_member_perms":"{snowflake}","guild_num_channels":4,"guild_num_roles":3,"guild_num_text_channels":3,"guild_num_voice_channels":1,"guild_size_total":2,"is...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable received: opcode 10
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-c-ts0q\",{\"micros\":0.0}]"],"heartbeat_interval":41250},"op":10,"s":null,"t":null}
  - docs:
...
- probable received: READY
  - payload shape: sha256:e0a9060cf4ec4b2cf68f0734004d469b05d74ab486556dee083ade96bee24750
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-c-ts0q\",{\"micros\":288552,\"calls\":[\"id_created\",{\"micros\":1393,\"calls\":[]},\"session_lookup_time\",{\"micros\":308,\"calls\":[]},\"session_lookup_finished\",{\"micros\":12,\"calls\":[]},\"sessions-prd-gcp-us-east1-c-120\",{\"micros\":286109,\"calls\":[\"start_session\",{\"micros\":265860,\"calls\":[\"prd-rpc-547f9f7987-c77pt\",{\"micros\":79269,\"calls\":[\"get_user\",{\"micros\":8870},\"get_guilds\",{\"micros\":34653},\"user_settings_proto\",{\"micros\":46},\"relationships\",{\"micros\":15},\"game_relationships\",{\"micros\":4},\"friend_suggestion\",{\"micros\":41},\"connections\",{\"micros\":15},\"serialized_read_states\",{\"micros\":5},\"send_scheduled_deletion_message\",{\"micros\":3},\"sanitize_premium_perks\",{\"micros\":3},\"...
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
...
## Step: Edit permission overwrite (edit-permission)

Actions:

- click / role:option / options:name
- expect-network / PUT /channels/{channel_id}/permissions/{role_id}
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"assignment_loaded_from_cache":false,"assignment_session_id":"{redacted}","assignment_source":"ready_payload","bucket":1,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBEbDFiMeEwEBZ4BAAAbAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":33,"excluded":false,"exposure_type":"manual","guild_id":"{guild_id}","hash_result":5093,"holdout_name":null,"launch_signature":"{uuid}","location":"GuildPowerupsManager","location_stack":[],"name":"{redacted_string}","rendered_locale":"en-US","revision":2,"uptime_app":3},"t...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBEbDFiMeEwEBZ4BAAAiAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":40,"launch_signature":"{uuid}","received_etag":"W/\"2e044f14966184cddd86e64f71cce135\"","rendered_locale":"en-US","request_method":"get","sent_etag":"","status_code":200,"uptime_app":3,"url":"{redacted_string}"},"type":"network_action_detectable_non_games_fetch"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /users/@me/billing/user-offer
  ...
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
- direct: PUT /channels/{channel_id}/permissions/{role_id}
  - status codes: 204
  - request shape: sha256:b17879da300a73b7b8b8d392641b06afd4b263da5b90505640bf4d6a495dbd7f
  - request sample redacted: {"allow":"0","deny":"0","id":"{role_id}","type":0}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply

Gateway:

- probable received: CHANNEL_UPDATE
  - payload shape: sha256:cb5f47615c89b8a312b68a4efd4fc034370d275823767c7fbb20b4df74668d89
  - payload sample redacted: {"d":{"flags":0,"guild_id":"{guild_id}","icon_emoji":{"id":null,"name":"{redacted_string}"},"id":"{channel_id}","last_message_id":"{snowflake}","last_pin_timestamp":"{phone}T00:14:{phone}+00:00","name":"{redacted_string}","nsfw":false,"parent_id":"{snowflake}","permission_overwrites":[{"allow":"0","deny":"2048","id":"{guild_id}","type":0},{"allow":"0","deny":"0","id":"{role_id}","type":0}],"position":0,"rate_limit_per_user":0,"theme_color":null,"topic":null,"type":0,"version":"{timestamp}"},"op":0,"s":9,"t":"CHANNEL_UPDATE"}
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
- probable received: GUILD_AUDIT_LOG_ENTRY_CREATE
  - payload shape: sha256:70f7a19d93ed2f83be4e5a307b8fe0a1d505e7329e44aa516e7b8cc84304ae78
  - payload sample redacted: {"d":{"action_type":13,"changes":[{"key":"id","new_value":"{role_id}"},{"key":"type","new_value":0},{"key":"allow","new_value":"0"},{"key":"deny","new_value":"0"}],"guild_id":"{guild_id}","id":"{snowflake}","options":{"id":"{role_id}","role_name":"{redacted_string}","type":"0"},"target_id":"{channel_id}","user_id":"{user_id}"},"op":0,"s":10,"t":"GUILD_AUDIT_LOG_ENTRY_CREATE"}
