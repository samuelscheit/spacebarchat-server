...
- probable: GET /users/@me/survey
  ...
  - response sample redacted: {"global":false,"message":"You are being rate limited.","retry_after":80611.613}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- probable received: opcode 10
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-b-8cpt\",{\"micros\":0.0}]"],"heartbeat_interval":41250},"op":10,"s":null,"t":null}
  - docs:
...
- probable received: READY
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-b-8cpt\",{\"micros\":592284,\"calls\":[\"id_created\",{\"micros\":1081,\"calls\":[]},\"session_lookup_time\",{\"micros\":4097,\"calls\":[]},\"session_lookup_finished\",{\"micros\":11,\"calls\":[]},\"sessions-prd-gcp-us-east1-b-98\",{\"micros\":586250,\"calls\":[\"start_session\",{\"micros\":539196,\"calls\":[\"prd-rpc-547f9f7987-lc7g8\",{\"micros\":355624,\"calls\":[\"get_user\",{\"micros\":27466},\"get_guilds\",{\"micros\":35541},\"user_settings_proto\",{\"micros\":5817},\"relationships\",{\"micros\":14761},\"game_relationships\",{\"micros\":4},\"friend_suggestion\",{\"micros\":34},\"connections\",{\"micros\":12},\"serialized_read_states\",{\"micros\":4},\"send_scheduled_deletion_message\",{\"micros\":2},\"sanitize_premium_perks\",{\"micros\...
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
...
- expect-network / PUT /channels/{channel_id}/messages/pins/{message_id}
- expect-gateway / CHANNEL_PINS_UPDATE / received
...
- probable: GET /channels/{channel_id}/messages
  ...
  - response sample redacted: [{"attachments":[],"author":"{redacted}","channel_id":"{channel_id}","components":[],"content":"{redacted_string}","edited_timestamp":null,"embeds":[],"flags":0,"id":"{snowflake}","mention_everyone":false,"mention_roles":[],"mentions":[],"pinned":false,"timestamp":"{phone}T22:57:{phone}+00:00","tts":false,"type":0},{"attachments":[],"author":"{redacted}","channel_id":"{channel_id}","components":[],"content":"{redacted_string}","edited_timestamp":null,"embeds":[],"flags":0,"id":"{snowflake}","mention_everyone":false,"mention_roles":[],"mentions":[],"pinned":false,"timestamp":"{phone}T22:53:{phone}+00:00","tts":false,"type":0},{"attachments":[],"author":"{redacted}","channel_id":"{channel_id}","components":[],"content":"{redacted_string}","edited_timestamp":null,"embeds":[],"flags":0,"id"...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: GET /content-inventory/users/@me
  ...
  - response sample redacted: {"entries":[],"entries_hash":0,"expired_at":"{phone}T00:24:{phone}+00:00","refresh_stale_inbox_after_ms":30000,"refresh_token":"{redacted}","request_id":"991d76753e164787b439b6022c35e638","unranked_game_entries":[],"wait_ms_until_next_fetch":617505}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- probable: GET /users/@me/application-command-index
  - status codes: 200
  - response shape: sha256:2567d6311a25c8e3f024c9b206488af8cb85aa598df52ab9452b171e9f614a07
  - response sample redacted: {"application_commands":[{"application_id":"{snowflake}","contexts":[0,1,2],"description":"{redacted_string}","dm_permission":true,"handler":1,"id":"{snowflake}","integration_types":[0,1],"name":"{redacted_string}","type":4,"version":"{snowflake}"},{"application_id":"{snowflake}","contexts":[0,1,2],"description":"{redacted_string}","dm_permission":true,"global_popularity_rank":1,"id":"{snowflake}","integration_types":[0,1],"name":"{redacted_string}","type":1,"version":"{snowflake}"}],"applications":[{"bot_id":"{snowflake}","description":"{redacted_string}","embedded_activity_config":{"supported_platforms":["web","ios","android"]},"flags":"28442626","icon":"{redacted_string}","id":"{snowflake}","name":"{redacted_string}"},{"bot_id":"{user_id}","description":"{redacted_string}","flags":"5...
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- probable: GET /users/@me/settings-proto/2
  ...
  - response sample redacted: {"settings":""}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
- probable: PATCH /users/@me/settings-proto/2
  - status codes: 200
  - request shape: sha256:3bc6a58318372b5fb79303310048eb484a1ec86d8517c99814581d1076fc42a9
  - request sample redacted: {"settings":""}
  - response shape: sha256:3bc6a58318372b5fb79303310048eb484a1ec86d8517c99814581d1076fc42a9
  - response sample redacted: {"settings":""}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBH34rXudhrvBJ4BAAAWAAAA","client_viewport_height":720,"client_viewport_width":1280,"error_message":"You are being rate limited.","event_sequence_number":28,"launch_signature":"{uuid}","rendered_locale":"en-US","request_method":"get","status_code":429,"uptime_app":2,"url":"{redacted_string}"},"type":"network_action_user_survey_fetch"},{"properties":{"accessibility_features":524416,"bypass_fatigue":true,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memor...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"app_hardware_acceleration_enabled":true,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBH34rXudhrvBJ4BAAAYAAAA","client_viewport_height":720,"client_viewport_width":1280,"css_compressed_byte_size":473007,"css_transfer_byte_size":0,"css_uncompressed_byte_size":3219433,"duration_ms_since_app_opened":3650,"event_sequence_number":30,"js_compressed_byte_size":517685,"js_transfer_byte_size":0,"js_uncompressed_byte_size":2097788,"launch_signature":"{uuid}","load_id":"{uuid}","rendered_locale":"en-US","screen_name":"{redacted_string}","total_compress...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"assignment_loaded_from_cache":false,"assignment_session_id":"{redacted}","assignment_source":"ready_payload","bucket":1,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBH34rXudhrvBJ4BAAAZAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":31,"excluded":false,"exposure_type":"manual","guild_id":"{guild_id}","hash_result":5093,"holdout_name":null,"launch_signature":"{uuid}","location":"GuildPowerupsManager","location_stack":[],"name":"{redacted_string}","rendered_locale":"en-US","revision":2,"uptime_app":3},"t...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBH34rXudhrvBJ4BAAAgAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":38,"launch_signature":"{uuid}","received_etag":"W/\"2e044f14966184cddd86e64f71cce135\"","rendered_locale":"en-US","request_method":"get","sent_etag":"","status_code":200,"uptime_app":3,"url":"{redacted_string}"},"type":"network_action_detectable_non_games_fetch"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:4a54b4032616d3d384ef0cb2cd1787ec5ec92541c9364fd14fbbf1fc7cf2dad7
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBH34rXudhrvBJ4BAAAhAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":39,"launch_signature":"{uuid}","received_etag":"W/\"5b47f{phone}bdd4135c560c3144\"","rendered_locale":"en-US","request_method":"get","sent_etag":"","status_code":200,"uptime_app":3,"url":"{redacted_string}"},"type":"network_action_detectable_applications_fetch"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:c0b0f62c0027f5505f261208d646670fc4bf627706b89d7d0cdd0413006ac145
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"assignment_loaded_from_cache":false,"assignment_session_id":"{redacted}","assignment_source":"ready_payload","bucket":1,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBH34rXudhrvBJ4BAAAiAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":40,"excluded":false,"exposure_type":"auto_fallback","guild_id":"{guild_id}","hash_result":5093,"holdout_name":null,"launch_signature":"{uuid}","location":"maybeGetGameServerHostingGuildEligiblePopoutDCF","location_stack":[],"name":"{redacted_string}","rendered_locale":"en-U...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"channel":"{channel_id}","client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBH34rXudhrvBJ4BAAAjAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":41,"launch_signature":"{uuid}","location":"right_click","message_id":"{message_id}","rendered_locale":"en-US","uptime_app":4},"type":"message_popout_menu_opened_desktop"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBH34rXudhrvBJ4BAAAkAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":42,"launch_signature":"{uuid}","miss":true,"rendered_locale":"en-US","size":0,"uptime_app":4},"type":"application_command_cache_fetch"},{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}"...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:9871a4679115a42d7af342cf8abf14bb5b740b571ccf39cce87d4d8c94d84c9a
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"channel_id":"{channel_id}","client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBH34rXudhrvBJ4BAAAmAAAA","client_viewport_height":720,"client_viewport_width":1280,"event_sequence_number":44,"guild_id":"{guild_id}","launch_signature":"{uuid}","message_id":"{message_id}","rendered_locale":"en-US","time_to_close_ms":64,"uptime_app":4},"type":"message_menu_time_to_close"},{"properties":{"accessibility_features":524416,"channel_id":"{channel_id}","client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"clien...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"aborted":false,"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBH34rXudhrvBJ4BAAAoAAAA","client_viewport_height":720,"client_viewport_width":1280,"command_type":null,"duration_ms":176.5,"error":false,"event_sequence_number":46,"failure_statuses":[],"include_applications":true,"kind":null,"launch_signature":"{uuid}","rendered_locale":"en-US","retries":0,"target_id":null,"target_type":"user","uptime_app":4,"url":"{redacted_string}"},"type":"application_command_performance"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"aborted":false,"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBH34rXudhrvBJ4BAAApAAAA","client_viewport_height":720,"client_viewport_width":1280,"command_type":null,"duration_ms":206.10000002384186,"error":false,"event_sequence_number":47,"failure_statuses":[],"include_applications":true,"kind":null,"launch_signature":"{uuid}","rendered_locale":"en-US","retries":0,"target_id":"{guild_id}","target_type":"guild","uptime_app":4,"url":"{redacted_string}"},"type":"application_command_performance"}],"token":"{redacted}"}
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /users/@me/billing/user-offer
  ...
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
- direct: PUT /channels/{channel_id}/messages/pins/{message_id}
  - status codes: 204
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
...
- probable sent: opcode 8
  ...
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
- probable received: CHANNEL_PINS_ACK
  - payload shape: sha256:5dd8bde9f0ad8a63e9969e7bacc211d25eb49feaa2a74b32306d593c6c1ffa0f
  - payload sample redacted: {"d":{"channel_id":"{channel_id}","timestamp":"{phone}T00:14:{phone}+00:00","version":232},"op":0,"s":8,"t":"CHANNEL_PINS_ACK"}
- direct received: CHANNEL_PINS_UPDATE
  - payload shape: sha256:ea9bae00fd87ccdf96c22c13ecb7ef484d3b46812d3bdbda169798d3ee6e3370
  - payload sample redacted: {"d":{"channel_id":"{channel_id}","guild_id":"{guild_id}","last_pin_timestamp":"{phone}T00:14:{phone}+00:00"},"op":0,"s":10,"t":"CHANNEL_PINS_UPDATE"}
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
- probable received: GUILD_AUDIT_LOG_ENTRY_CREATE
  - payload shape: sha256:cb5832e5c990973ec13e2c15de5b31c4ffd311f6569ca27418eae49344d9f0b2
  - payload sample redacted: {"d":{"action_type":74,"guild_id":"{guild_id}","id":"{snowflake}","options":{"channel_id":"{channel_id}","message_id":"{message_id}"},"target_id":"{user_id}","user_id":"{user_id}"},"op":0,"s":13,"t":"GUILD_AUDIT_LOG_ENTRY_CREATE"}
...
- probable received: MESSAGE_CREATE
  - payload shape: sha256:b84411b8e0d399d07530990d0532560a7db1c0ee21b08cd6ccd0acf297b4b14d
  - payload sample redacted: {"d":{"attachments":[],"author":"{redacted}","channel_id":"{channel_id}","channel_type":0,"components":[],"content":"{redacted_string}","edited_timestamp":null,"embeds":[],"flags":0,"guild_id":"{guild_id}","id":"{snowflake}","member":{"avatar":null,"banner":null,"communication_disabled_until":null,"deaf":false,"flags":0,"joined_at":"{phone}T09:12:{phone}+00:00","mute":false,"nick":null,"pending":false,"premium_since":null,"roles":[]},"mention_everyone":false,"mention_roles":[],"mentions":[],"message_reference":{"channel_id":"{channel_id}","message_id":"{message_id}","type":0},"pinned":false,"timestamp":"{phone}T00:14:{phone}+00:00","tts":false,"type":6},"op":0,"s":11,"t":"MESSAGE_CREATE"}
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
- probable received: MESSAGE_UPDATE
  - payload shape: sha256:658a496771d17be969fd9b0d5c933f4edacda6a2b539845fb70e16b490de4c9d
  - payload sample redacted: {"d":{"attachments":[],"author":"{redacted}","channel_id":"{channel_id}","channel_type":0,"components":[],"content":"{redacted_string}","edited_timestamp":null,"embeds":[],"flags":0,"guild_id":"{guild_id}","id":"{message_id}","member":{"avatar":null,"banner":null,"communication_disabled_until":null,"deaf":false,"flags":0,"joined_at":"{phone}T22:46:{phone}+00:00","mute":false,"nick":null,"pending":false,"premium_since":null,"roles":["{snowflake}"]},"mention_everyone":false,"mention_roles":[],"mentions":[],"pinned":true,"timestamp":"{phone}T23:11:{phone}+00:00","tts":false,"type":0},"op":0,"s":9,"t":"MESSAGE_UPDATE"}
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
- probable received: USER_SETTINGS_PROTO_UPDATE
  - payload shape: sha256:73a52ba5f8eeff97610094310b727a87a0bf40b656f59adb9ccc4105b9ac90ea
  - payload sample redacted: {"d":{"partial":false,"settings":{"proto":"","type":2}},"op":0,"s":12,"t":"USER_SETTINGS_PROTO_UPDATE"}
