# Feature: Switch guilds

Run: 2026-05-07T23-06-28Z-stable-local
Scenario: navigation.guild_switch
...
## Step: Open primary guild (open-primary)
...
- probable: GET /users/@me/survey
  ...
  - response sample redacted: {"global":false,"message":"You are being rate limited.","retry_after":83509.877}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
...
- background received: opcode 10
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-c-twkk\",{\"micros\":0.0}]"],"heartbeat_interval":41250},"op":10,"s":null,"t":null}
  - docs:
...
- probable received: READY
  ...
  - payload sample redacted: {"d":{"_trace":["[\"gateway-prd-arm-us-east1-c-twkk\",{\"micros\":161808,\"calls\":[\"id_created\",{\"micros\":1575,\"calls\":[]},\"session_lookup_time\",{\"micros\":245,\"calls\":[]},\"session_lookup_finished\",{\"micros\":12,\"calls\":[]},\"sessions-prd-gcp-us-east1-c-177\",{\"micros\":159409,\"calls\":[\"start_session\",{\"micros\":138674,\"calls\":[\"prd-rpc-547f9f7987-tqbgx\",{\"micros\":58520,\"calls\":[\"get_user\",{\"micros\":6280},\"get_guilds\",{\"micros\":19795},\"user_settings_proto\",{\"micros\":1434},\"relationships\",{\"micros\":4298},\"game_relationships\",{\"micros\":4},\"friend_suggestion\",{\"micros\":37},\"connections\",{\"micros\":11},\"serialized_read_states\",{\"micros\":4},\"send_scheduled_deletion_message\",{\"micros\":12},\"sanitize_premium_perks\",{\"micros\":...
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
...
## Step: Switch to secondary guild (switch-guild)

Actions:

- click / role:treeitem / options:name
- expect-ready
- expect-network / POST /guilds/{guild_id}/migrate-command-scope
- expect-gateway / CHANNEL_INFO / received
...
- probable: GET /guilds/{guild_id}/entitlements
  - status codes: 429
  - response shape: sha256:03c791a2bff466a1f917bc4db83ed31cddd76160e2ce2fe94070faff2bd6e015
  - response sample redacted: {"global":false,"message":"You are being rate limited.","retry_after":4.902}
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
- probable: GET /guilds/{guild_id}/integrations
  ...
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
- direct: POST /guilds/{guild_id}/migrate-command-scope
  - status codes: 200
  - response shape: sha256:f248e244bf1528c3a9e627b6c71fd5b02fc0f9f265f60cbe5b87fba10c6b46ed
  - response sample redacted: {"integration_ids_with_app_commands":[]}
  - static candidates:
...
- probable: POST /science
  - status codes: 204
  - request shape: sha256:f0bbbeff269eb09f8e701bb575cad2eba1df6b459c01dbd25e968a69c3e196e7
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFtjAUOA+DCBJ4BAAAWAAAA","client_viewport_height":720,"client_viewport_width":1280,"evaluation_id":"61f72003","event_sequence_number":28,"experiment":"2025-10-friendship-anniversary-gifting","exposure_location":"PremiumGiftingIntentManager handleChannelSelect","launch_signature":"{uuid}","rendered_locale":"en-US","tracked_variation_id":2,"unit_type":"user","uptime_app":2},"type":"experiment_user_evaluation_exposed"},{"properties":{"accessibility_features":524416,"assignment_loaded_from_cache":fals...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
    - high / sentry.36796a94df4938db.js / module apply
- probable: POST /science
  - request shape: sha256:aacbc877faba5a364ad3798a296ee87c66dfc751865b166cd3f2ca70587b306b
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFtjAUOA+DCBJ4BAAAiAAAA","client_viewport_height":720,"client_viewport_width":1280,"error_message":"You are being rate limited.","event_sequence_number":40,"launch_signature":"{uuid}","location":"impression_guild_channel","location_page":"impression_guild_channel","rendered_locale":"en-US","request_method":"get","status_code":429,"uptime_app":2,"url":"{redacted_string}"},"type":"network_action_user_survey_fetch"},{"properties":{"accessibility_features":524416,"bypass_fatigue":true,"client_app_stat...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable: POST /science
  ...
  - request sample redacted: {"events":[{"properties":{"accessibility_features":524416,"app_hardware_acceleration_enabled":true,"client_app_state":"focused","client_heartbeat_session_id":"{redacted}","client_performance_memory":0,"client_rtc_state":"DISCONNECTED","client_send_timestamp":"{timestamp}","client_track_timestamp":"{timestamp}","client_uuid":"FhCA6HzRHBFtjAUOA+DCBJ4BAAAkAAAA","client_viewport_height":720,"client_viewport_width":1280,"css_compressed_byte_size":473779,"css_transfer_byte_size":0,"css_uncompressed_byte_size":3222030,"duration_ms_since_app_opened":4188,"event_sequence_number":42,"js_compressed_byte_size":517620,"js_transfer_byte_size":0,"js_uncompressed_byte_size":2097723,"launch_signature":"{uuid}","load_id":"{uuid}","rendered_locale":"en-US","screen_name":"{redacted_string}","total_compress...
  - docs:
    - official_api_reference: https://docs.discord.com/developers/reference
    - userdoccers_reference: https://docs.discord.food/reference
  - static candidates:
...
- probable sent: opcode 8
  ...
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
- direct received: CHANNEL_INFO
  - payload shape: sha256:36862976ac03f2c49fbb9bc3c18c483008d01eb48c18e522b8755c75a047a539
  - payload sample redacted: {"d":{"channels":[{"id":"{snowflake}"},{"id":"{channel_id}"},{"id":"{snowflake}"},{"id":"{snowflake}"}],"guild_id":"{guild_id}"},"op":0,"s":8,"t":"CHANNEL_INFO"}
  - static candidates:
    - high / fast-connect.38fb8ec2baeaa13d.js / module QUEST_PREVIEW_TOOL_2
- probable received: GUILD_MEMBERS_CHUNK
  ...
  - payload sample redacted: {"d":{"chunk_count":1,"chunk_index":0,"guild_id":"{guild_id}","members":[{"avatar":null,"banner":null,"communication_disabled_until":null,"deaf":false,"flags":0,"joined_at":"{phone}T22:46:{phone}+00:00","mute":false,"nick":null,"pending":false,"premium_since":null,"roles":["{snowflake}"],"user":{"avatar":null,"avatar_decoration_data":null,"bot":true,"collectibles":null,"discriminator":"0807","display_name":null,"display_name_styles":null,"global_name":null,"id":"{user_id}","primary_guild":null,"public_flags":0,"username":"{redacted_string}"}}],"not_found":[]},"op":0,"s":10,"t":"GUILD_MEMBERS_CHUNK"}
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
- probable received: THREAD_LIST_SYNC
  - payload shape: sha256:d472054853b3eca920baeba428f678ac1834cc6b4ab998a1888e3324b035b354
  - payload sample redacted: {"d":{"guild_id":"{guild_id}","most_recent_messages":[],"threads":[]},"op":0,"s":9,"t":"THREAD_LIST_SYNC"}
  - docs:
    - official_gateway_reference: https://docs.discord.com/developers/events/gateway
    - userdoccers_gateway_events: https://docs.discord.food/gateway/gateway-events
