...
import { ActionResultBanner, DestructiveActionFields, ErrorBanner, PageHeader, PaginationControls, Panel, ReturnToField, RowLink, SearchForm, StatusPill } from "../../components";
...
export default async function UsersPage({ searchParams }: { searchParams: Promise<{ q?: string; offset?: string; actionSuccess?: string; actionError?: string }> }) {
    const params = await searchParams;
    const offset = parseOffsetParam(params.offset);
    const returnTo = `/users${queryString({ q: params.q, offset })}`;
