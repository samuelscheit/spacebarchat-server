...
export interface GuildGrowthActivationAnalyticsQuery {
    start?: Date;
    end?: Date;
...
export function parseGuildGrowthActivationAnalyticsQuery(query: Request["query"]): GuildGrowthActivationAnalyticsQuery {
    const parsed = {
