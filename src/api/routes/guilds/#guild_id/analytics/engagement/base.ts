...
export interface GuildEngagementBaseQuery {
    start?: Date;
    end?: Date;
...
export function parseGuildEngagementBaseQuery(query: Request["query"]): GuildEngagementBaseQuery {
    const parsed = {
...
router.get(
    ...
    async (req: Request, res: Response) => {
        parseGuildEngagementBaseQuery(req.query);
