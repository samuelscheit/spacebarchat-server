...
const originalMethods = {
    ...
    memberCreateQueryBuilder: util.Member.createQueryBuilder,
...
afterEach(() => {
    ...
    util.Member.createQueryBuilder = originalMethods.memberCreateQueryBuilder;
...
test("widget invite generation retries global code collisions", async () => {
    ...
    util.Member.createQueryBuilder = () => emptyWidgetMemberQuery;
