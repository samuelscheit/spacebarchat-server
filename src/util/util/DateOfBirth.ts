...
export function evaluateDateOfBirth(dateOfBirth: DateOfBirthInput | null | undefined, minimumAge: number | undefined, referenceDate = new Date()): DateOfBirthEvaluation {
    if (dateOfBirth == null) return { status: "missing" };
