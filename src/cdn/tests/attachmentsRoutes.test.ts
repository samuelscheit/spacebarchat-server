...
describe("attachment CDN mutation routes", () => {
    test("server-internal attachment mutations are not exposed on the public attachment route", async () => {
    ...
    test("all server-internal attachment mutations are exposed on the internal CDN route", async () => {
