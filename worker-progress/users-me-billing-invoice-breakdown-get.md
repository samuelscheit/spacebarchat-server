...
- `npm run test:manifest` passed and verified 738 entries on the current base.
...
- Original worker base missing entries: 550.
- Current pushed base before porting: 548.
- Current missing entries after porting: 547.
- Current-base movement: -1.
- Current base had assigned `GET /users/@me/billing/invoice/breakdown`: yes.
...
- Ported over pushed base `165a85071`, preserving the already-merged saved-messages and Adyen route artifacts. Regenerated artifacts now report 547 missing, 633 Spacebar routes, and 1128 Discord routes.
