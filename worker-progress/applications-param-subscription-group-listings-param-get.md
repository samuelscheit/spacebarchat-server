...
- Worker base: `missing = 550`, `spacebar = 630`.
- Worker branch after regeneration: `missing = 549`, `spacebar = 631`.
- Current integration base before merge: `missing = 546`, `spacebar = 634`.
- Current integration base after regeneration: `missing = 545`, `spacebar = 635`.
...
- Current-base merge verification repeated `build:src:tsgo`, schema/OpenAPI/source-catalog/missing-route/testing-manifest/contract/suite regeneration, generated-artifact checks, `build:test-fixtures`, focused compiled route test, `test:manifest`, and `test:suite-coverage`: pass.
